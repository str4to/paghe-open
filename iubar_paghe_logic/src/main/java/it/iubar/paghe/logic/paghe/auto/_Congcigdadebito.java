...
import it.iubar.paghe.logic.paghe.Congcigdcausadd;

/**
 * Class _Congcigdadebito was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _Congcigdadebito extends CayenneDataObject {
    ...
    public static final String TO_CONG_CIGD_CAUS_ADD_PROPERTY = "toCongCigdCausAdd";
    ...
    public void setToCongCigdCausAdd(Congcigdcausadd toCongCigdCausAdd) {
        setToOneTarget("toCongCigdCausAdd", toCongCigdCausAdd, true);
    }

    public Congcigdcausadd getToCongCigdCausAdd() {
        return (Congcigdcausadd)readProperty("toCongCigdCausAdd");
    }
