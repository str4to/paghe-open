...
/**
 * Class _Cigautorizzata was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _Cigautorizzata extends CayenneDataObject {
    ...
    public static final String NUMAUTORIZZAZIONE_PROPERTY = "numautorizzazione";
    ...
    public void setNumautorizzazione(String numautorizzazione) {
        writeProperty("numautorizzazione", numautorizzazione);
    }
    public String getNumautorizzazione() {
        return (String)readProperty("numautorizzazione");
    }
