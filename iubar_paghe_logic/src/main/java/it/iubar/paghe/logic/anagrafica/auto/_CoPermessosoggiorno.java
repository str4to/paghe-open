...
/**
 * Class _CoPermessosoggiorno was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _CoPermessosoggiorno extends CayenneDataObject {

    public static final String DESCRIZIONE_PROPERTY = "descrizione";
    public static final String IDPERMESSO_PROPERTY = "idpermesso";
    ...
    public static final String IDPERMESSO_PK_COLUMN = "IDPERMESSO";
    ...
    public String getIdpermesso() {
        return (String)readProperty("idpermesso");
    }
